-- Backfill missing profiles and link referrers from signup metadata.
...
begin
  ...
  values (new.id, new.email, profile_username, profile_avatar, profile_referral_code, referred_email)
...
select u.id, u.email, public.assign_unique_referral_code()
from auth.users u
